package com.example.administrator.headcare.toolBars;
...
import com.example.administrator.headcare.R;
...
public class Themometer extends View {
    ...
    private int COLOR_GREEN =  Color.parseColor("#FF99CC00");
...
//        Drawable d = getResources().getDrawable(R.drawable.applebtn);
//        d.setBounds(r2);
//        d.draw(canvas);
    }
